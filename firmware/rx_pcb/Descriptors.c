/*
  ...
  Please note, that the below code was based on the Descriptors.c
  file written by Dean Camera, with licence terms described below.
*/
...
USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
  {
    ...
    /* We set the Vendor ID/Product ID to VUSB "MIDI CLASS" value */
    .VendorID               = 0x16c0,
    .ProductID              = 0x05e4,
...
USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor =
  {
    ...
    // Start of section pasted by WZab
	.MIDI_Audio_StreamInterface =
		{
			.Header                   = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},
	...
	.MIDI_Audio_StreamInterface_SPC =
		{
...
USB_Descriptor_String_t PROGMEM ManufacturerString =
  {
    ...
    .UnicodeString          = L"WZab http://www.ise.pw.edu.pl/~wzab/MIDI"
  };
...
USB_Descriptor_String_t PROGMEM ProductString =
  {
    ...
    .UnicodeString          = L"WZab Digital Wireless Guitar System 1"
  };
