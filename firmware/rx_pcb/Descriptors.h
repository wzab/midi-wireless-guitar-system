/*
  ...
  Please note, that the below code was based on the Descriptors.h
...
//		#define AUDIO_STREAM_EPSIZE          ENDPOINT_MAX_SIZE(AUDIO_STREAM_EPNUM)
                #define AUDIO_STREAM_EPSIZE          252 // Must be multiple of 3
...
// End of macros pasted by WZab
	/* Type Defines: */
		...
		typedef struct
		{
		  ...
		  // Start of pasted section WZab
			USB_Descriptor_Interface_t                MIDI_Audio_StreamInterface;
			USB_MIDI_Descriptor_AudioInterface_AS_t   MIDI_Audio_StreamInterface_SPC;
